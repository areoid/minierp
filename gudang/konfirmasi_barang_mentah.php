<!DOCTYPE HTML>
<!-- halaman konfirmasi barang mentah gudang -->
<?php
...
<html>
	<head>
		...
		<title>Konfirmasi Barang Mentah - Gudang</title>
		...
		<script type="text/javascript" charset="utf-8">
			$(document).ready(function(){
				// list terkonfirmasi
				$("#divListTerkonfirmasi").load("../src/gudang/proses_konfirmasi_barang_mentah.php?action=listTerkonfirmasi");

				// list permintaan
				$("#divListPermintaanBarang").load("../src/gudang/proses_konfirmasi_barang_mentah.php?action=listPermintaanBarang");
...
function lihatTerkonfirmasi(kode){
	$.ajax({
		url: "../src/gudang/proses_konfirmasi_barang_mentah.php?action=lihatTerkonfirmasi&pKode="+kode,
		cache: false,
...
function lihatPermintaan(kode){
	...
	$.ajax({
		type: "GET",
		url: "../src/gudang/proses_konfirmasi_barang_mentah.php?action=lihatPermintaan",
		data:{
			pKode:kode
		},
		cache: false,
		success: function(hasilLihat){
			$("#dialogLihatPermintaan").html(hasilLihat);
			$("#dialogLihatPermintaan").dialog({
				position:['middle',20],
				resizeable:true,
				width:1000,
				modal: true,
				buttons: {
					"Selesai": function() {
						...
						$.ajax({
							type: "GET",
							url: "../src/gudang/proses_konfirmasi_barang_mentah.php?action=konfirmasiSelesai&pNoSPI="+vNoSPI,
							cache: false,
							success: function(hasilKonfirmasiSelesai){
								alert(hasilKonfirmasiSelesai);
								$("#dialogLihatPermintaan").dialog("close");
								$("#divListTerkonfirmasi").load("../src/gudang/proses_konfirmasi_barang_mentah.php?action=listTerkonfirmasi");
								$("#divListPermintaanBarang").load("../src/gudang/proses_konfirmasi_barang_mentah.php?action=listPermintaanBarang");
							}
						});
					...
					Cancel: function() {
						...
						$.ajax({
							type: "GET",
							url: "../src/gudang/proses_konfirmasi_barang_mentah.php?action=konfirmasiCancel&pNoSPI="+vNoSPI,
							cache: false,
...
function printTerkonfirmasi(kode){
	var url = "../src/gudang/proses_konfirmasi_barang_mentah.php?action=printTerkonfirmasi&kode="+kode;
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active" class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#">Konfirmasi Barang Mentah</a></li>
...
<div class="thumbnail">
	<div class="caption">
		<div id="divListPermintaanBarang">
