...
<html>
	<head>
		...
		<title>Lap. Transaksi Barang (Mentah) - Gudang</title>
		...
		$(window).load(function() { $("#loading").fadeOut("slow"); });
			$(document).ready(function() {
				...
				$("#formFilter").submit(function() {
					...
					$.ajax({
						type: "POST",
						url: "../src/gudang/proses_lap_jurnal.php?action=filter",
						data: {
							pBulanA:vBulanA,
							pTahunA:vTahunA,
							pBulanB:vBulanB,
				...
				$("#divTabelLapBarang").load("../src/gudang/proses_lap_jurnal.php?action=jurnalBarang");

				// auto tahun
				$(".classTahun").load("../src/gudang/proses_lap_jurnal.php?action=autoTahun");
...
6	    height: 100%;
7	    z-index: 9999;
8	    background: url(loading.gif) 50% 50% no-repeat #ede9df;
9}
</style>
	</head>
	<body>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown active">
          ...
          <ul class="dropdown-menu">
            <li><a href="#">Laporan Barang Mentah</a></li>
